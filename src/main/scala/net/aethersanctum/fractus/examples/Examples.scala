...
object Examples extends (String => Option[RuleBasedFractal]) {
  ...
  val sierpinski = RuleBasedFractal("sierpinski",
  ...
  val spirally = RuleBasedFractal("spirally",
  ...
  val spirally2 = RuleBasedFractal("spirally2",
  ...
  val blockTree = RuleBasedFractal("block-tree",
  ...
  val circles = RuleBasedFractal("circles",
  ...
  val gorgon = RuleBasedFractal("gorgon",
  ...
  val gorgon2 = RuleBasedFractal("gorgon2",
  ...
  val fern = RuleBasedFractal("fern",
    rule.weight(4).color(RED).colorWeight(0.8).transform((v: Vector2) => {
      new Vector2(
  ...
  val dualSpiral = RuleBasedFractal("dual-spiral",
  ...
  val sinx = RuleBasedFractal("sinx",
  ...
  val pinkFur3 = RuleBasedFractal("pinkfur3",
  ...
  val alienBlueCheeseLotus = RuleBasedFractal("AlienBlueCheeseLotus",
  ...
  val alienBlueCheeseLotus2 = ruleSetScaled("AlienBlueCheeseLotus2", List(
    // THIS ONE IS A FULLY AWESOME DERIVATIVE OF THE ALIEN BLUE CHEESE FRACTAL
  ...
  val alienBlueCheeseOriginal = RuleBasedFractal("AlienBlueCheese",
  ...
  val borfo = RuleBasedFractal("Borfo",
    // blorp
  ...
  val taffy1 = RuleBasedFractal("taffy-1",
    List(
  ...
  val hazyLines = RuleBasedFractal("hazylines",
    List(
  ...
  val purpleBrain = ruleSetScaled("purple-brain",
    List(
  ...
  val mandelbrotLikeBoundary = ruleSetScaled("mlike-boundary", // makes a vaguely mandelbrot-set-boundary shape
    List(
  ...
  val mandelbrotLikeBoundary2 = ruleSetScaled("mlike-boundary-2",
    List(
  ...
  val filamentReactor = ruleSetScaled("filament-reactor",
    List(
  ...
  val filamentReactor2 = ruleSetScaled("filament-reactor-2",
    List(
  ...
  val eggs = RuleBasedFractal("eggs",
  ...
  val eggsMirror = RuleBasedFractal("eggs_mirror",
  ...
  val polar1 = RuleBasedFractal("polar1",
    weight(1).color(GREEN).colorWeight(0.5).polar.scale(-0.5, 0.25).translate(2, 2),
    weight(4).color(GREEN).colorWeight(0.5).also(_ + Vector(0, -1))
  )
  val polar2 = RuleBasedFractal("polar2",
  ...
  val polar3 = RuleBasedFractal("polar3",
  ...
  val polar5 = RuleBasedFractal("polar5",
    //   weight(2).color(ORANGE).colorWeight(0.3).rotate(72).invertRadius.scale(4),
  ...
  val polar6 = RuleBasedFractal("polar6",
  ...
  private val items: Map[String, RuleBasedFractal] = Map(
    ...
    pinkFur2,
    pinkFur3,
    alienBlueCheeseLotus,
    alienBlueCheeseLotus2,
    alienBlueCheeseOriginal,
    borfo,
    taffy1,
    hazyLines,
    purpleRain,
    purpleRain2,
    purpleBrain,
    mandelbrotLikeBoundary,
    mandelbrotLikeBoundary2,
    filamentReactor,
    filamentReactor2,
    eggs,
    eggsMirror,
